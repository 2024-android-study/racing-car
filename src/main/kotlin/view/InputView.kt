...
class InputView {
    companion object {
        ...
        private const val ERROR_NAME_LENGTH = "자동차의 이름은 5자 이하로 입력해주세요"
        private const val ERROR_NAME_EMPTY = "자동차의 이름이 빈칸입니다"
        private const val ERROR_TIME_EMPTY = "시도 횟수가 빈칸입니다"
        private const val ERROR_TIME_ZERO = "0이 아닌 자연수를 입력해 주세요"
        private const val ERROR_TIME_NOT_NUMBER = "시도 횟수는 숫자만 입력해 주세요"
    }
